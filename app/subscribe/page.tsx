...
export default function Subscribe() {
  ...
  return (
    <Suspense fallback={<p className="text-white text-5xl">LOADING...</p>}>
      <main
      ...
      >
        ...
        {subStatus ? (
          <div className="space-y-6">
            <h3 className="text-[#ecedee] text-4xl">
              You are already subscribed.
            </h3>
            <form action="/api/portal" method="POST">
              <button
                type="submit"
                className="bg-[#10253E] hover:bg-[#102C4C] text-blue-600 text-sm font-semibold rounded-full px-5 py-3 transition-all duration-200 ease-in"
              >
                Manage Subscription
              </button>
            </form>
