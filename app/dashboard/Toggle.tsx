...
export default function Toggle({ deletePost, setToggle }: ToggleProps) {
  return (
    ...
    >
      <div className="position absolute bg-white top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-12 rounded-lg flex flex-col gap-6 justify-center">
        ...
        <button
          className="bg-red-600 text-sm text-white py-3 px-4 rounded-md"
          onClick={deletePost}
        >
          Delete Post
        </button>
